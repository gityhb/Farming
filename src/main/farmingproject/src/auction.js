                    ...
                    <div className={'auction_container'}>
                        <div className={'auction_content'}>
                            <div className={'auction_content_item'}>
                                <div className={'item_sec_1'}>10/03 10:00 예정</div>
                            ...
                            <div className={'auction_content_item'}>
                                <Link to={"/auction_detail"}>
                                    <div className={'item_sec_1'}>10/03 12:00 예정</div>
                                    <div className={'item_sec_2'}>
                                        <img src={"img/watermelon_3.png"} alt="상품 사진" />
                                        <div className={'item_name'}>프리미엄 고당도 꿀수박 50통</div>
                                        <div className={'item_minbid'}>최소 입찰가 | 750,000원</div>
                                    </div>
                            ...
                            <div className={'auction_content_item'}>
                                <div className={'item_sec_1'}>10/04 13:00 예정</div>
                                <div className={'item_sec_2'}>
                        ...
                        <div className={'auction_content'}>
                            <div className={'auction_content_item'}>
                                <div className={'item_sec_1'}>10/05 15:00 예정</div>
                                <div className={'item_sec_2'}>
                            ...
                            <div className={'auction_content_item'}>
                                <div className={'item_sec_1'}>10/06 13:00 예정</div>
                                <div className={'item_sec_2'}>
                            ...
                            <div className={'auction_content_item'}>
                                <div className={'item_sec_1'}>10/07 08:00 예정</div>
                                <div className={'item_sec_2'}>
